...
image_ids = open("dataset_processing/classfication/ImageSets/Segmentation/val.txt",'r').read().splitlines()

if not os.path.exists("miou_pr_dir"):
    os.makedirs("miou_pr_dir")

for image_id in tqdm(image_ids):
    image_path = "dataset_processing/classfication/JPEGImages/"+image_id+".jpg"
