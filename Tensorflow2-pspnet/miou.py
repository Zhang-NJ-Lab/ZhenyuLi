...
if __name__ == "__main__":
    gt_dir = "dataset_processing/classfication/SegmentationClass"
    pred_dir = "miou_pr_dir"
    png_name_list = open("dataset_processing/classfication/ImageSets/Segmentation/val.txt",'r').read().splitlines()
    #------------------------------#
    #   分类个数+1
    #------------------------------#
    num_classes = 7
    ...
    #--------------------------------------------#
    name_classes = ["_background_","fabric", "glass", "leather", "metal", "plastic", "wood"]
